...
class _IslandScreenState extends State<IslandScreen>
  ...
  int get _totalStars => _gameConfig.fold(0, (s, g) => s + _starsOf(g.key));
  ...
  void _goTo(String key) {
    ...
    switch (key) {
      case 'listening':
        screen =
            ListeningGameScreen(islandId: widget.islandId, theme: widget.theme);
        break;
      ...
      case 'memory':
        screen =
            MemoryGameScreen(islandId: widget.islandId, theme: widget.theme);
        break;
      case 'word_builder':
        screen =
            WordBuilderScreen(islandId: widget.islandId, theme: widget.theme);
        break;
      default:
        return;
    }
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          height: 38,
          decoration:
              const BoxDecoration(color: LKColors.sun, shape: BoxShape.circle),
